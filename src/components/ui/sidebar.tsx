  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-background/90 backdrop-blur-sm p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-150 relative h-svh w-[--sidebar-width] bg-transparent transition-[width]",
        ...
        <div
          className={cn(
            "duration-150 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] md:flex",
            side === "left"
